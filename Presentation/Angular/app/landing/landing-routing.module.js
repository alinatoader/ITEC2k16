System.register(["@angular/core", "@angular/router", "./landing.component"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, landing_component_1, LandingRoutingModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            LandingRoutingModule = class LandingRoutingModule {
            };
